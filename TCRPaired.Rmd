...
# Then, add column for receptors which are homologous to the reference crystal structures (same epitope and CDR3 sequences with > 90% similarity or matching VJ genes)\
all.reference.distinct <- fetchHomologs(all.reference.distinct, structures.final, threshold = 0.75)
...
## PIEMA benchmark data

Section temporary, needs to be moved to PIEMA directory when documenting
