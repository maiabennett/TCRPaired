...
Here, a sample dataset is prepared for use training and testnig various TCR specificity prediction methods. This dataset includes the Chan Medical College data, IEDB data, McPAS data, and VDJdb data. The dataset is filtered to remove redundant receptor sequences, empty sequences, and CDR sequences and filtered to remove receptors with > 95% CDR3 sequence similarity; and negative data is generated for the dataset at ... (complete SwarmTCRTools, then revisit)
